                        ...
                        <div class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none relative z-11">
                            <div class="max-w-md w-full space-y-8">
                                <div class="text-center text-white">
                                    ...
                                    <div>
                                        <a href="{{ route('fund.login') }}" class="w-full flex justify-center bg-gradient-to-r from-indigo-500 to-blue-600 hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-600 text-gray-100 p-4 rounded-full tracking-wide font-semibold shadow-lg cursor-pointer transition ease-in duration-500">Sign in</a>
                                    </div>
                                    <p class="flex flex-col items-center justify-center mt-10 text-center text-md">
                                        <span>まだアカウントをお持ちでない方</span>
                                        <a href="{{ route('fund.register') }}"
                                            class="hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">支援者アカウント作成</a>
                                    </p>
                                </div>
                                ...
                                <div class="text-center text-white">
                                    ...
                                    <p class="flex flex-col items-center justify-center mt-10 text-center text-md">
                                        ...
                                        <a href="{{ route('user.register') }}"
                                            class="hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">起案者アカウント作成</a>
                                    </p>
                                </div>
                            </div>
                        </div>
